...
class CoTProvider(IReasoningEngine):
    """
    Провайдер для Chain-of-Thought рассуждения.
    Обеспечивает интеграцию CoTReasoning в систему, обрабатывая конфигурацию и зависимости.
    """
    ...
    def __init__(
        ...
        """
        self.config = config or settings.COT_CONFIG
        self.engine = CoTReasoning(
    ...
    async def reason(
        ...
        **kwargs
        ...
        """
        Выполняет рассуждение, делегируя вызов движку CoTReasoning.
